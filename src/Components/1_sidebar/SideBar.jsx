...
export default function SideBar() {
    return (
        <div className='w-20 md:w-64 bg-[#925FE2] rounded-3xl p-10 text-[#c6bbd9] flex flex-col items-center gap-5 min-h-[90vh] capitalize'>
            ...
            <nav className='mt-4 w-full'>
                <ul className='w-full text-center'>
                    <li className='hover:text-white'>
                        <NavLink className={`flex gap-3 items-center p-4 hover:bg-[#C0A3EE] cursor-pointer rounded-3xl`}>
