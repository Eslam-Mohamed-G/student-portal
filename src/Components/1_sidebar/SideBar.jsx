        ...
        <div className={`bg-[#153e6a] text-white flex flex-col fixed top-0 z-50 items-center gap-5 min-h-screen md:min-h-[90vh] md:rounded-3xl capitalize md:relative`}>
            ...
            <button onClick={handleMenu} className={`'block md:hidden absolute top-6 ${isOpen ? "end-2" : "-end-10"}`}>
                {isOpen ?
                    ...
                    :
                    <svg class="w-6 h-6 text-white" aria-hidden="true" fill="currentColor" viewBox="0 0 17 17" xmlns="http://www.w3.org/2000/svg">
                ...
                <nav className='mt-4 flex-1'>
                    <ul className='text-center transition-all duration-300'>
                        <li className='hover:text-white transition-all duration-200'>
                            <NavLink to={'/'} onClick={() => { handleMenu() }} className={`flex gap-2 h-12 items-center ${isOpen ? "ps-4": "justify-center"} md:justify-start md:ps-4 hover:bg-[#3b9dd4] cursor-pointer rounded-3xl transition-all duration-200`}>
                        ...
                        <li className='hover:text-white transition-all duration-200'>
                            <NavLink to={'timeTable'} onClick={() => { handleMenu() }} className={`flex gap-2 h-12 items-center ${isOpen ? "ps-4": "justify-center"} md:justify-start md:ps-4 hover:bg-[#3b9dd4] cursor-pointer rounded-3xl transition-all duration-200`}>
                                <svg class="w-6 h-6 text-white block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
